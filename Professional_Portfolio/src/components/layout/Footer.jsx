        ...
        <footer className="bg-slate-50 dark:bg-black relative z-10 transition-colors duration-500">
            <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10">
                ...
                <div className="bg-white dark:bg-black">
                    <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-slate-300 dark:divide-white/10 border-b border-slate-300 dark:border-white/10">
                        {socialLinks.map((social, index) => (
                            <a
                                ...
                                className="group relative h-24 flex items-center justify-center overflow-hidden hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                            >
