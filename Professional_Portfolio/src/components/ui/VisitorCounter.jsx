...
const VisitorCounter = () => {
    ...
    return (
        <section className="w-full border-b border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-black transition-colors duration-500">
            <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10 relative overflow-hidden">
                ...
                <div className="flex items-center justify-center py-8 relative group">
                    ...
                    <div className="flex flex-col items-center gap-2 relative z-10 transition-transform duration-300 group-hover:scale-105">
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-200/50 dark:bg-white/5 border border-slate-300 dark:border-white/10">
