                ...
                <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10">
                    <div className="grid grid-cols-2 md:grid-cols-4">
                        {technologies.map((tech, index) => (
                            <div
                                key={index}
                                className="bg-slate-50/50 dark:bg-black/50 p-8 flex flex-col items-center justify-center gap-4 group hover:bg-white dark:hover:bg-black transition-colors relative border-r border-b border-slate-300 dark:border-white/5 last:border-r-0 md:last:border-r-0 [&:nth-child(2n)]:border-r-0 md:[&:nth-child(2n)]:border-r [&:nth-child(4n)]:border-r-0"
                            >
