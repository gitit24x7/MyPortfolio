    ...
    return (
        <section className="min-h-screen flex flex-col justify-center relative z-10 transition-colors duration-500">
            ...
            <div className="mt-10 sm:mt-20">
                ...
                {/* Row 1: Name & System Metadata (Full Width) */}
                <div className="w-full border-y border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-black relative group/row overflow-hidden transition-colors duration-500">
                    <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10 relative z-10 transition-colors duration-500 overflow-hidden">
                        ...
                        <div className="grid grid-cols-4 relative z-10">
                            {/* Left Content */}
                            <div className="col-span-3 p-3 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-center sm:justify-between relative min-h-[90px] sm:min-h-0">
                            ...
                            <div
                                className="col-span-1 border-l border-slate-300 dark:border-white/10 relative overflow-hidden transition-all duration-700 filter grayscale hover:grayscale-0"
                                style={{
                ...
                <div className="w-full border-b border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-black relative group/row overflow-hidden transition-colors duration-500">
                    <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10 relative z-10 transition-colors duration-500 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 pointer-events-none" />
                        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.03] brightness-100 contrast-100 mix-blend-overlay pointer-events-none"></div>
                        <div className="grid grid-cols-4 relative z-10">
                            {/* Left Content */}
                            <div className="col-span-3 p-3 sm:p-6 flex flex-col sm:flex-row items-center justify-center sm:justify-between relative min-h-[90px] sm:min-h-0">
                                <div className="absolute inset-0 bg-white/0 group-hover/row:bg-white/[0.02] transition-colors duration-500" />
            ...
            <div className="w-full border-b border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-black transition-colors duration-500">
                <div className="max-w-5xl mx-auto border-x border-slate-300 dark:border-white/10 py-10 sm:py-20 px-4 sm:px-6 text-center relative">
            ...
            <div className="w-full border-b border-slate-200/50 dark:border-white/10 bg-slate-50/30 dark:bg-black/20 transition-colors duration-500">
                <div className="max-w-5xl mx-auto border-x border-slate-200/50 dark:border-white/10 py-6 sm:py-12 px-4 sm:px-6 flex justify-center">
